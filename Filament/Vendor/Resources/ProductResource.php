...
class ProductResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Store Listings';
                    ...
                    ->tabs([
                        Tab::make('Inventory')
                            ->schema([
                                ...
                                TextInput::make('length')->label('Total stock'), // Assuming price is in dollars
                                TextInput::make('max_quantity')->label('Maximum Purchase Quantity Limit'),
                                // Add more fields as needed

                            ])->columns(2),
                        Tab::make('Product Specifications')
                            ->schema([

                                Fieldset::make('Weight (KG)')
                                    ->schema([
                                        TextInput::make('weight')->label(''),

                                    ]),
                                Fieldset::make('Dimentions (CM)')
                                    ->schema([
                                        TextInput::make('length')->label('Length'), // Assuming price is in dollars
                                        TextInput::make('width')->label('Width'), // Assuming price is in dollars
                                        TextInput::make('height')->label('height'), // Assuming price is in dollars
